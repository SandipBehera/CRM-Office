...
@endphp
        ...
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{url('/admin/create-property')}}" >
                        ...
                        <li>
                            <a href="{{url('/admin/amminites')}}">
                                <i class="metismenu-icon"></i>Ammenities
                            </a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{url('/admin/Frontend/banner')}}" >
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="{{url('/admin/leads-report')}}" >
                                <i class="metismenu-icon"></i>Lead Report
                            </a>
                        </li>
                    </ul>
                </li>
    ...
    @elseif(Session::get('Manager-Role'))
    <div class="scrollbar-sidebar">
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                <li class="app-sidebar__heading">Menu</li>
                <li>
                    <a href="{{url('/crm-manager/dashboard')}}">
                        <i class="metismenu-icon pe-7s-rocket"></i>Dashboard
                    </a>
                </li>
                <li class="app-sidebar__heading">Leads Management</li>
                <li>
                    <a href="{{url('/crm-manager/today-assign')}}">
                        <i class="metismenu-icon"></i>Assign Lead
                    </a>
                </li>
                <li>
                    <a href="{{url('/crm-manager/follow-up-assign')}}">
                        <i class="metismenu-icon"></i> Follow-Up Lead
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="scrollbar-sidebar">
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li>
                    <a href="#">
                        <i class="metismenu-icon pe-7s-news-paper"></i>My Profile
                        <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                    </a>
                    <ul>
                        <li>
                            <a href="{{url('/crm-employee/attendence')}}">
                                <i class="metismenu-icon"></i>My Attendence
                            </a>
                        </li>
                        <li>
                            <a href="{{url('/crm-employee/myprofile')}}">
                                <i class="metismenu-icon"></i>My Profile
                            </a>
                        </li>
                        <li>
                            <a href="{{url('/crm-employee/all-employee')}}">
                                <i class="metismenu-icon"></i>All Employee
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="app-sidebar__heading">Properties Components</li>
                <li>
                    <a href="#">
                        <i class="metismenu-icon pe-7s-news-paper"></i>Properties
                        <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                    </a>
                    <ul>
                        <li>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{url('/crm-employee/today-assign')}}" >
                                    <i class="metismenu-icon"></i>Today Assigned Leads
                                </a>
                        </li>
                        <li>
                            <a href="{{url('/crm-employee/overdue-leads')}}" >
                                    <i class="metismenu-icon"></i>OverDue Calls Leads
                                </a>
                        </li>
                        <li>
