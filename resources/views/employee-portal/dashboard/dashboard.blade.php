            ...
            <div class="row">
                    ...
                    <div class="card mb-3 widget-content bg-night-fade">
                        <div class="widget-content-wrapper text-white">
                            <div class="widget-content-left">
                                ...
                                <div class="widget-subheading">Total leads</div>
                            </div>
                            <div class="widget-content-right">
                            <div class="widget-numbers text-white"><span>{{$Assigned_leads}}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="card mb-3 widget-content bg-arielle-smile">
                        <div class="widget-content-wrapper text-white">
                            <div class="widget-content-left">
                                <div class="widget-heading">Due Calls for today</div>
                                <div class="widget-subheading">Total Clients to call</div>
                            </div>
                            <div class="widget-content-right">
                            <div class="widget-numbers text-white"><span>{{$due_code_today}}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-3 widget-content bg-asteroid">
                        <div class="widget-content-wrapper text-white">
                            <div class="widget-content-left">
                                ...
                                <div class="widget-subheading">Total Overdue calls</div>
                            </div>
                            <div class="widget-content-right">
                            <div class="widget-numbers text-white"><span>{{$over_due_calls}}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-3 widget-content bg-happy-green">
                        <div class="widget-content-wrapper text-white">
                            <div class="widget-content-left">
                                ...
                                <div class="widget-subheading">Total Dead calls</div>
                            </div>
                            <div class="widget-content-right">
                            <div class="widget-numbers text-white"><span>{{$dead_calls}}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="mb-0 table">
                                        ...
                                        <tbody>
                                            @php
                                                $i=1;
                                            @endphp
                                            @if (!empty($site_visit_data))
                                            @foreach ($site_visit_data as $site_visit_item)
                                            @php
                                            $leads_comment=LeadsComment::where('lead_id','=',$site_visit_item->lead_id)->where('lead_status','=','site visit Initate')->first();
                                            $leads=Leads::where('id','=',$site_visit_item->lead_id)->first();
                                            @endphp
                                            <tr>
                                                <th>
                                                    {{$i++}}
                                                ...
                                                <th>{{$leads->phone}}</th>
                                                <th>
                                                    @if (!empty($leads_comment->followup_date))
                                                    {{$leads_comment->followup_date}}
                                                    @else
                                                        Not Assigned Any Date
                                                    @endif

                                                </th>
                                                <th><a href="" class="btn-wide btn btn-success">View</a></th>
                                            </tr>
                                           @endforeach
                                            @endif
