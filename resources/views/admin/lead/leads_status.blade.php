                                    ...
                                    <div class="mb-3 card">
                                        <div class="card-header-tab card-header">
                                            ...
                                            <div class="btn-actions-pane-right text-capitalize">
                                                <a href="{{url('/admin/leads')}}" class="btn-wide btn-outline-2x mr-md-2 btn btn-outline-focus btn-sm">View All</a>
                                            </div>
                                        </div>
                                        <div class="no-gutters row">
                                            <div class="col-sm-6 col-md-2 col-xl-3">
                                                <div class="card no-shadow rm-border bg-transparent widget-chart text-left">
                                                    ...
                                                    <div class="widget-chart-content">
                                                        <div class="widget-subheading">All Leads </div>
                                                    <div class="widget-numbers">{{$Datacount}}</div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-6 col-md-2 col-xl-3">
                                                <div class="card no-shadow rm-border bg-transparent widget-chart text-left">
                                                    ...
                                                    <div class="widget-chart-content">
                                                        <div class="widget-subheading">Over Due calls</div>
                                                        <div class="widget-numbers"><span>{{$over_due_call}}</span></div>
                                                    </div>
                                                </div>
                                                <div class="divider m-0 d-md-none d-sm-block"></div>
                                            </div>
                                            <div class="col-sm-12 col-md-2 col-xl-3">
                                                <div class="card no-shadow rm-border bg-transparent widget-chart text-left">
                                                    ...
                                                    <div class="widget-chart-content">
                                                        <div class="widget-subheading">Closed Leads</div>
                                                    <div class="widget-numbers text-success"><span>{{$closed_call_count}}</span></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-md-2 col-xl-3">
                                                <div class="card no-shadow rm-border bg-transparent widget-chart text-left">
                                                    ...
                                                    <div class="widget-chart-content">
                                                        <div class="widget-subheading">Dead Leads</div>
                                                        <div class="widget-numbers text-success"><span>{{$dead_leads_count}}</span></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="btn-actions-pane-right text-capitalize actions-icon-btn">
                                                        <div class="btn-group dropdown">
                                                            ...
                                                            <div tabindex="-1" role="menu" aria-hidden="true"
                                                                ...
                                                                <h6 tabindex="-1" class="dropdown-header">Status By</h6>
                                                                <button type="button" tabindex="0" class="dropdown-item">
                                                                    <i class="dropdown-icon lnr-inbox"> </i><span>Year</span>
                                                                </button>
                                                                <button type="button" tabindex="0" class="dropdown-item">
                                                                    <i class="dropdown-icon lnr-file-empty"> </i><span>Month</span>
                                                                </button>
                                                                <button type="button" tabindex="0" class="dropdown-item">
                                                                    <i class="dropdown-icon lnr-book"> </i><span>Week</span>
                                                                </button>
                                                                <button type="button" tabindex="0" class="dropdown-item">
                                                                    <i class="dropdown-icon lnr-book"> </i><span>Day</span>
                                                                </button>
                                                                    ...
                                                                    <div class="widget-chat-wrapper-outer">
                                                                        <div class="widget-chart-content widget-chart-content-lg pb-0">
                                                                            <div class="widget-chart-flex">
                                                                                <div class="widget-title opacity-5 text-muted text-uppercase"> ALL Leads</div>
                                                                            </div>
                                                            ...
                                                            <div>
                                                                <div class="widget-chart widget-chart2 text-left p-0">
                                                                    <div class="widget-chat-wrapper-outer">
                                                                        <div class="widget-chart-content widget-chart-content-lg pb-0">
                                                                            <div class="widget-chart-flex">
                                                                                <div class="widget-title opacity-5 text-muted text-uppercase"> Lead status Total</div>
                                                                            </div>
                                                                            <div class="widget-numbers">
                                                                                <div class="widget-chart-flex">
                                                                                    <div>
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <span class="opacity-5 text-muted pl-2 pr-1">0%</span>
                                                                                        increase
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="widget-chart-wrapper he-auto opacity-10 m-0">
                                                                            <canvas id="pie-chart" height="30" width="100">
                                                                            </canvas>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <div class="widget-content-outer">
                                                                            <div class="widget-content-wrapper">
                                                                                <div class="widget-content-left">
                                                                                    <div class="widget-numbers fsize-3 text-muted">{{$Datacount}}</div>
                                                                                </div>
                                                                            ...
                                                                            <div class="widget-progress-wrapper mt-1">
                                                                                <div class="progress-bar-sm progress-bar-animated-alt progress">
                                                                                    <div class="progress-bar bg-danger" role="progressbar"
                                                                                        aria-valuenow="{{$Datacount}}" aria-valuemin="0" aria-valuemax="100"
                                                                                        style="width: {{$Datacount}}%;">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="widget-content">
                                                                        <div class="widget-content-outer">
                                                                            <div class="widget-content-wrapper">
                                                                                <div class="widget-content-left">
                                                                                    <div class="widget-numbers fsize-3 text-muted">0%</div>
                                                                                </div>
                                                                                <div class="widget-content-right">
                                                                                    <div class="text-muted opacity-6">Closed Leads</div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="widget-progress-wrapper mt-1">
                                                                                <div class="progress-bar-sm progress-bar-animated-alt progress">
                                                                    ...
                                                                    <div class="widget-content">
                                                                        <div class="widget-content-outer">
                                                                            <div class="widget-content-wrapper">
                                                                                ...
                                                                                <div class="widget-content-right">
                                                                                    <div class="text-muted opacity-6">Dead Leads</div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="widget-progress-wrapper mt-1">
                                                                                <div class="progress-bar-sm progress-bar-animated-alt progress">
                                                                    ...
                                                                    <div class="widget-content">
                                                                        <div class="widget-content-outer">
                                                                            <div class="widget-content-wrapper">
                                                                                ...
                                                                                <div class="widget-content-right">
                                                                                    <div class="text-muted opacity-6">Active Leads</div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="widget-progress-wrapper mt-1">
                                                                                <div class="progress-bar-sm progress-bar-animated-alt progress">
...
<!-- Pie chart for leads assinged or not assinged-->
<script>
...
<!-- Line ploat for leads Generation per day-->
<script>
