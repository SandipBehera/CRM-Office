            ...
            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                <div class="main-card mb-3 card">
                    ...
                    @endif
                        ...
                        <form class="" method="post" action="{{url('/controlpanel/create-property')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-row">
                                <div class="col-md-4">
                            ...
                            <div class="form-row">
                                ...
                                <div class="position-relative form-check form-check-inline">
                                    ...
                                    <input type="checkbox" name="amenities[]" value="{{$item->amminites_name}}" class="form-check-input"><i class="{{$item->icon_id}}"></i>{{$item->amminites_name}}
                                    </label>
                                </div>
                                @endforeach
                                @else
                            ...
                            <div class="form-row" id="increment_input">
                                ...
                                <div class="col-md-12">
                                    <div class="position-relative form-group">
                                        <h5 class="card-title">Floor Images</h5>
                                        <div class="col-md-12" >
                                            <div id="filediv"><input name="fimage[]" id="gallery-photo-add"  type="file" multiple="">
                                                <div class="gallery" style="padding-top:3% "></div>
                                            </div>
                            ...
                            <div class="form-row">
                            <div class="col-md-12">
                                <input name="pimage[]" id="property-gallery-photo-add"  type="file" multiple="">
                                <div class="property-gallery" style="padding-top:3% "></div>
                            </div>
                            </div>
                            <div class="divider"></div>
                            <div class="form-row">
