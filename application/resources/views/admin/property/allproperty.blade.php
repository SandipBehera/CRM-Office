    ...
    <div class="app-main__inner">
        ...
        <div class="row">
                ...
                @php
                    ...
                    $property_image=property_image::where(['pif'=>$item->property_id])->where('property_image','!=',null)->first();
                ...
                @endphp
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card-header">{{$item->property_name}}</div>
                            ...
                            <a href="{{url('/controlpanel/view-propeties/'.$item->property_name.'')}}" class="mb-2 mr-2 btn btn-shadow btn-gradient-success">View</a>
